...
class SuitesControllerTest < ActionController::TestCase
  ...
  test "should create suite" do
    assert_difference('Suite.count') do
      post :create, suite: { description: @suite.description, name: @suite.name, project: @suite.project }
    end
  ...
  test "should update suite" do
    patch :update, id: @suite, suite: { description: @suite.description, name: @suite.name, project: @suite.project }
    assert_redirected_to suite_path(assigns(:suite))
  end
