...
class PrioritiesControllerTest < ActionController::TestCase
  ...
  test "should create priority" do
    assert_difference('Priority.count') do
      post :create, priority: { display_order: @priority.display_order, is_default: @priority.is_default, label: @priority.label, name: @priority.name }
    end
  ...
  test "should update priority" do
    patch :update, id: @priority, priority: { display_order: @priority.display_order, is_default: @priority.is_default, label: @priority.label, name: @priority.name }
    assert_redirected_to priority_path(assigns(:priority))
  end
