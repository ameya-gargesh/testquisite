...
class CaseTypesControllerTest < ActionController::TestCase
  ...
  test "should create case_type" do
    assert_difference('CaseType.count') do
      post :create, case_type: { display_order: @case_type.display_order, label: @case_type.label, name: @case_type.name }
    end
  ...
  test "should update case_type" do
    patch :update, id: @case_type, case_type: { display_order: @case_type.display_order, label: @case_type.label, name: @case_type.name }
    assert_redirected_to case_type_path(assigns(:case_type))
  end
